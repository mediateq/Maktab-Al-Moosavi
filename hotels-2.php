...
<section class="hotels">
	...
	<ul>
		<li>
			<div class="tit"><h2>فندق فردوس</h2></div>
			<div class="text">
				<p>
	...
	<ul>
		...
		<li>
			<div class="tit"><h2>فندق بشری</h2></div>
			<div class="text">
				<p>
	...
	<ul>
		<li>
			<div class="tit"><h2>فندق خلیج فارس</h2></div>
			<div class="text">
				<p>
					الفندق قصر طلایي الدولي،ثاني فندق من مجموعة فنادق قصر الدولي و هو اکبر فندق في مدینة مشهد المقدسة قد تم بناءه فی سنة 2012 ...
				</p>
	...
	<ul>
		...
		<li>
			<div class="tit"><h2>فندق کیانا</h2></div>
			<div class="text">
				<p>
	...
	<ul>
		<li>
			<div class="tit"><h2>فندق سهند</h2></div>
			<div class="text">
				<p>
					قد تاسس هذا الفندق فی بدایة2013 و هو فندق نظيف و جميل و قريب الي الحرم المطهر و مسافته الي الحرم5دقائق مشيا علي الاقىام ...
				</p>
